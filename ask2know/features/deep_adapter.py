...
class DeepFeatureAdapter:
    """Required CLIP image embedding adapter for Ask2Know v0.4.63.0.

    v0.4.63.0 keeps OpenCLIP as the production embedding path. OpenCV embedding from
    ...
    def extract_image_vector(self, img):
        ...
        raise ValueError(
            f'Deep feature provider {self.provider!r} is not supported in Ask2Know v0.4.63.0. '
