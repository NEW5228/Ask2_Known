...
class PrototypeModel:
    def __init__(
        ...
        self.robust_min_samples = max(2, int(self.robust_config.get('min_samples', 12)))
        self.robust_trim_fraction = max(0.0, min(0.4, float(self.robust_config.get('trim_fraction', 0.12))))
